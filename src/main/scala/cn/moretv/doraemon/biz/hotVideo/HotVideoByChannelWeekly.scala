...
import cn.moretv.doraemon.common.constant
...
* */
object HotVideoByChannelWeekly extends BaseClass {
  ...
  override def execute(args: Array[String]): Unit = {
    ...
    contentTypeList.foreach(contentType => {
      ...
      val daysOfAWeek:Int = 7
      val numDaysOfData = new DateRange("yyyyMMdd", daysOfAWeek)
...
/*      val env = BaseParams.getParams(args).env
      ...
      */
      BizUtils.outputWrite(hotVideoDF, s"hotVideo/$contentType")
    })
  }
}