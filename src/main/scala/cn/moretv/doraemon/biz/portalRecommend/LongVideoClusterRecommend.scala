...
import cn.moretv.doraemon.algorithm.longVideoCluster.{LongVideoClusterAlgorithm, LongVideoClusterParameters}
...
object LongVideoClusterRecommend extends BaseClass {
  ...
  override def execute(args: Array[String]): Unit = {
    try {
      ...
      longVideoClusterAlgorithm.getOutputModel.output("longVideoClusterRecommend")
    } catch {
      case e: Exception => {
        throw e
      }
