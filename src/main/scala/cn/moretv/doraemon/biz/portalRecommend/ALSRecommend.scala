...
object ALSRecommend extends BaseClass{
  ...
  override def execute(args: Array[String]): Unit = {
    try {
      ...
      //首页今日推荐的基础数据
      val alsResult = ALSRecommend(userFactorsRaw, itemFactorRaw, 300,
        videoData, weightVideos, userWatched, frontPageExposedLongVideos)
      BizUtils.outputWrite(alsResult,"ALS/recommend")
      ...
      BizUtils.outputWrite(alsVipResult,"ALS/vipRecommend")
    } catch {
